    ...
    <body>
        ...
        <div class="box">
            ...
            <form method="post" action="laggatill.php">  
                ...
                <input type="text" class="Ljud" name="titel" max="50" placeholder="Ljudbok titel?" required>
                <input type="text" class="Ljud" name="forf" max="50" placeholder="Författare" required>
                <input type="time" class="Ljud" name="langd" max="50" placeholder="Längd" required>
                <input type="text" class="Ljud" name="genre" max="50" placeholder="Genre" required>
                <input type="text" class="Ljud" name="rost" max="50" placeholder="Röst" required>
                <input type="submit">
            </form> 
        ...
        <div class="container">
        <div class="rubrik"><h2>Admin</h2></div>
            <div class="print">
            
                <h2>Personers information</h2>
                <?php
                    // Person print
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "Namn: " . $row["Namn"]." - Admin: " . $row["Admin"]. "<br>";
                        }
                    } else {
                    echo "0 results";
                    }
