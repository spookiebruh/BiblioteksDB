...
<body>
    <form method="post" action="laggatill.php">  
            ...
            <input type="checkbox" id="bok" name="forf"  placeholder="Admin eller inte?" required="required">
            <input type="submit">
    </form> 
    ...
    <form method="post" action="laggatill.php">  
            ...
            <input type="checkbox" id="bok" name="ref" Min="0" Max="1" placeholder="Referens" required="required">
            <input type="submit">
        </form>  
        <form method="post" action="laggatill.php">  
            <input type="hidden" name="ljud">
            <input type="text" id="Film" name="titel2" max="100" placeholder="Lägga till ljudbok?" required="required">
            <input type="text" id="Film" name="forf2" max="100" placeholder="Författare" required="required">
            <input type="number" id="Film" name="langd" max="100" placeholder="Längd" required="required">
        ...
        <form method="post" action="laggatill.php">  
            ...
            <input type="text" id="Film" name="titel3" max="100" placeholder="Lägga till film?" required="required">
            <input type="text" id="Film" name="regi" max="100" placeholder="Regissör" required="required">
            <input type="number" id="Film" name="langd2" max="100" placeholder="Längd" required="required">
